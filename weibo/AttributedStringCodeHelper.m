...
+(void)encodeAttributedStringAttributes:(NSDictionary*)attributes withKeyedArchiver:(NSKeyedArchiver*)archiver     {
    ...
    for(key in attributes)
    {
        if([key isEqualToString:(NSString*)kCTFontAttributeName]) {
            ...
            [archiver encodeObject:[NSColor colorWithCGColor:color]  forKey:key];
        }
...
+(NSDictionary*)decodeAttributedStringAttriubtes:(NSKeyedUnarchiver*)decoder {
    ...
    if([decoder containsValueForKey:(NSString*)kCTForegroundColorAttributeName]) {
        [attributes setObject:(id)((NSColor*)[decoder decodeObjectForKey:(NSString *)kCTForegroundColorAttributeName]).CGColor forKey:(NSString*)kCTForegroundColorAttributeName];
    }
    
    if([decoder containsValueForKey:(NSString*)kCTStrokeColorAttributeName]) {
        [attributes setObject:(id)((NSColor*)[decoder decodeObjectForKey:(NSString *)kCTStrokeColorAttributeName]).CGColor forKey:(NSString*)kCTStrokeColorAttributeName];
    }
    
    if([decoder containsValueForKey:(NSString*)kCTUnderlineColorAttributeName]) {
        [attributes setObject:(id)((NSColor*)[decoder decodeObjectForKey:(NSString *)kCTUnderlineColorAttributeName]).CGColor forKey:(NSString*)kCTUnderlineColorAttributeName];
    }
